...
- **acelerografo**:
  ...
  - `drive_watchdog.py`: Auditor periódico de sincronización de archivos MiniSEED con Google Drive, detección de backlog y espacio libre en disco → [RSA-Acelerografo/docs/context/drive_watchdog_context.md](https://github.com/RedSismicaAustro/RSA-Acelerografo/blob/main/docs/context/drive_watchdog_context.md)
...
- **drive**:
  - @Milton: 2026/01/2026-01-28_correcion_bug_subida_drive.md, 2026/07/2026-07-23_correlador_eventos_regionales_mqtt.md, 2026/08/2026-08-31_reubicacion_respaldos_influxdb_gdrive.md, 2026/09/2026-09-01_diagnostico_adquisicion_cha01.md, 2026/09/2026-09-14_telemetria_sensor_drive_parada_seguridad.md
- **dsp**:
